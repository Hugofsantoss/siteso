...
export const lancamentos: Empreendimento[] = [
  {
    ...
    galeria: [
      {
        src: "/images/empreendimentos/galeria/concept-funcionarios-planta.jpg",
  ...
  },
  {
    ...
    galeria: [
      {
        src: "/images/empreendimentos/galeria/douro-planta.jpg",
        alt: "Planta de nível do Edifício D'Ouro",
        tipo: "planta",
      },
    ],
  },
